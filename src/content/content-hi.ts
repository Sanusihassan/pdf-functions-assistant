...
export const downloadFile: _downloadFile = {
  titles: {
    "assistant": ["आपका कार्य सफलतापूर्वक पूरा हो गया है!", "आपके कार्य सफलतापूर्वक पूरे हो गए हैं!"],
  },

  btnText: {
    "assistant": ["प्रक्रियाजित फ़ाइल डाउनलोड करें", "प्रक्रियाजित फ़ाइलें डाउनलोड करें"],
  },
